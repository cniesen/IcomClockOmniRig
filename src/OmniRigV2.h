...
private:
	OmniRig2::IOmniRigX* pOmniRigX = nullptr;
	OmniRig2::IRigXPtr pRig = nullptr;
	void displayOmniRigInfo(OmniRig2::IOmniRigX* pOmniRigX);
	void displayRigInfo(OmniRig2::IOmniRigX* pOmniRigX);
};