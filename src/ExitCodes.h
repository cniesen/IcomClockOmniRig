...
#define E_OPTION_TRANSCEIVER_MODEL -3
#define E_OPTION_TRANSCEIVER_ADDRESS -4
#define E_OPTION_OMNIRIG_VERSION -5
...
#define E_INTERNAL_OMNIRIG_SET_TIME 500
#define E_INTERNAL_OMNIRIG_SET_DATE 501
#define E_INTERNAL_OMNIRIG_SET_OFFSET 502

#define E_INTERNAL_COMMAND_MAP_TRANSCEIVER 600
#define E_INTERNAL_COMMAND_MAP_COMMAND 601
